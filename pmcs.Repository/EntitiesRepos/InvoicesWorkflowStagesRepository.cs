...
{
    public class InvoicesWorkflowStagesRepository : RepositoryBase<InvoiceWorkflowStage>
    {
        public InvoicesWorkflowStagesRepository(PmcsDbContext dbContext) : base(dbContext)
        {
        }
