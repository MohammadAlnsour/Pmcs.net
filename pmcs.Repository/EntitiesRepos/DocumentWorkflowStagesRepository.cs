...
{
    public class DocumentWorkflowStagesRepository : RepositoryBase<InvoiceWorkflowStage>
    {
        public DocumentWorkflowStagesRepository(PmcsDbContext dbContext) : base(dbContext)
        {
        }
