...
class InvoiceWorkflowAction extends React.Component {
    ...
    DoAction() {
        ...
        var settings = {
            method: "PUT",
            url: "/api/Invoices/DoInvoiceWorkflowAction",
        ...
        $.ajax(settings)
            .done(function (res) {
                $("#DivInvoiceWorkflowContainer").html(res);
                $("#InvoiceWorkflowActionModal").modal("hide");
                $("#TextWorkflowRemarks").val("");
                $.notify(
                    {
    ...
    ClearUpForm() {
        $("#FormInvoiceWorkflowAction")[0].reset();
    }
    RenderWorkflowAction() {
        ...
        if (workflowId !== '' && workflowId > 0) {
            ...
            $.get("/api/Invoices/GetInvoiceWorkflowDetail/" + workflowId)
    ...
    componentDidMount() {
        ...
        $("body").on("click", "button[id^='BtnApproveRejectWorkflow_']", function (e) {
            ...
            $('#InvoiceWorkflowActionModal').modal('show');
        });
    }
    CloseModal() {
        $("#InvoiceWorkflowActionModal").modal("hide");
    ...
    render() {
        ...
        return (
            <div>
                <div id="InvoiceWorkflowActionModal" className="modal" tabIndex="-1" role="dialog">
                    <div className="modal-dialog modal-lg" role="document">
                        <div className="modal-content" style={modalStyle}>
                            ...
                            <div className="modal-body">
                                <table className="table table-bordered" style={{ width: '60%' }}>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td> {this.state.workflow.InvoiceNumber} </td>
                                        </tr>
                                        <tr>
                                            <td>Payment Stage : </td>
                                ...
                                <br />
                                <form id="FormInvoiceWorkflowAction" name="FormInvoiceWorkflowAction">
                                    <div className="row">
                                        ...
                                        <div className="col-md-12">
                                            <div className="col-md-8">
                                                Remarks - Notes :
                                                <textarea id="TextWorkflowRemarks" maxLength='299' style={{ height: '100px' }} className="form-control"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </form>
...
ReactDOM.render(<InvoiceWorkflowAction />,
