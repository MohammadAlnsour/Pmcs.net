...
class CreateWorkflowStage extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            AllowedActions: "",
        ...
        this.addWorkflowStageModal = this.addWorkflowStageModal.bind(this);
        ...
        this.editWorkflowStage = this.editWorkflowStage.bind(this);
        this.closeEditModal = this.closeEditModal.bind(this);
    }

    componentDidMount() {
        this.editWorkflowStage();
        var component = this;
    ...
    editWorkflowStage() {
        ...
        $("body").on("click", "button[id^='BtnEditWorkflowStage_']", function (e) {
            var workflowStageId = $(this).attr("id").split("_")[1];
            $("#hiddenUpdatedStageId").val(workflowStageId);
            $.get("/api/WorkflowDesign/GetWorkflowStage/" + workflowStageId)
                .done(function (workflowStage) {
                    var actionsHtml = [];
                    if (workflowStage != null) {

                        $("#txtEditStageName").val(workflowStage.StageName);
                        ...
                        for (var i = 0; i < allowedActionsIds.length; i++) {
                            actionsHtml.push(
                                <div className="col-md-4">
                                    <label>
                                        <input type="checkbox" id={allowedActionsIds[i]} name="CheckBoxActionId" value={allowedActionsIds[i]} checked />
        ...
        $("body").on("click", "button[id^='BtnAddWorkflowStage_']", function (e) {
            var workflowStageId = $(this).attr("id").split("_")[1];
    ...
    addWorkflowStageModal(event) {
        $("#addWorkflowStage").modal("show");
        this.getAllowedActions();
    }

    closeModal() {
        $("#addWorkflowStage").modal("hide");
    }

    ClearUpForm() {
        $("#txtStageName").val("");
        $("input[name='CheckBoxActionId']").each(function () {
            $(this).prop("checked", false);
        });
        $("#FormEditWorkflowStage")[0].reset();
    }
                ...
                if (actions != null) {
                    for (var i = 0; i < actions.length; i++) {
                        actionsHtml.push(
                            <div className="col-md-4">
                                <label>
                                    <input type="checkbox" id={actions[i].ActionId} name="CheckBoxActionId" value={actions[i].ActionId} />
    ...
    SaveWorkflowStage() {
        ...
        if ($("#FormAddWorkflowStage").valid()) {
            ...
            var settings = {
                method: "POST",
                url: "/api/WorkflowDesign/PostWorkflowStage/",
    ...
    UpdateWorkflowStage() {
        ...
        $('#FormEditWorkflowStage').validate({
            rules: {
                txtEditStageName: {
                    required: true,
                    maxlength: 50,
        ...
        if ($("#FormEditWorkflowStage").valid()) {
            //var actionsIds = "";
            //$("input[name='CheckBoxActionId']").each(function () {
            //    if ($(this).prop("checked"))
            //        actionsIds += $(this).val() + ","
            ...
            var settings = {
                method: "PUT",
                url: "/api/WorkflowDesign/PutWorkflowStage/",
                contentType: "application/json",
                data: JSON.stringify({
                    StageName: $("#txtEditStageName").val(),
                    //AllowedActionsIds: actionsIds,
                    RoleId: $("#SelectRoleIdEdit").val(),
    ...
    render() {
        return (
            ...
            <div>
                <button className="btn btn-primary" onClick={this.addWorkflowStageModal}>
                    <i className="fa fa-plus-circle"></i>
                    Add New Stage
                </button>

                <div id="addWorkflowStage" className="modal" tabIndex="-1" role="dialog">
                                    ...
                                    <table style={{ width: '100%' }}>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" id="txtStageName" name="txtStageName" className="form-control" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colSpan="2">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select id="SelectRoleId" name="SelectRoleId" className="form-control">
                ...
                <div id="editWorkflowStage" className="modal" tabIndex="-1" role="dialog">
                    <div className="modal-dialog" role="document">
                        <div className="modal-content">
                            <div className="modal-header">
                                    ...
                                    <table style={{ width: '100%' }}>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" id="txtEditStageName" name="txtEditStageName" className="form-control" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colSpan="2">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select id="SelectRoleIdEdit" name="SelectRoleIdEdit" className="form-control">
                            ...
                            <div className="modal-footer">
                                <button type="button" className="btn btn-primary" onClick={this.UpdateWorkflowStage}>Edit Stage</button>
...
ReactDOM.render(
    <CreateWorkflowStage />,
    document.getElementById("divAddWorkflowStage"));